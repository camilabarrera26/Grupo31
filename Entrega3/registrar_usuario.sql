...
BEGIN
    ...
    IF rute LIKE '[123456789][0123456789][0123456789][0123456789][0123456789][0123456789][0123456789][0123456789]-[0123456789]' THEN 
        RETURN TRUE;
    END IF;
    IF rute LIKE '[123456789][0123456789][0123456789][0123456789][0123456789][0123456789][0123456789][0123456789]-[k]' THEN 
        RETURN TRUE;
    END IF;
    IF rute LIKE '[123456789][0123456789][0123456789][0123456789][0123456789][0123456789][0123456789][0123456789]-[K]' THEN 
        RETURN TRUE;
    ...
    IF rute LIKE '[123456789][0123456789][0123456789][0123456789][0123456789][0123456789][0123456789]-[0123456789]' THEN 
        RETURN TRUE;
    END IF;
    IF rute LIKE '[123456789][0123456789][0123456789][0123456789][0123456789][0123456789][0123456789]-[k]' THEN 
        RETURN TRUE;
    END IF;
    IF rute LIKE '[123456789][0123456789][0123456789][0123456789][0123456789][0123456789][0123456789]-[K]' THEN 
        RETURN TRUE;
