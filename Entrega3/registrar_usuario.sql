...
BEGIN
    ...
    IF rute NOT LIKE '[123456789][0123456789][0123456789][0123456789][0123456789][0123456789][0123456789][0123456789]-[0123456789]' THEN 
        RETURN TRUE;
    END IF;
    IF rute NOT LIKE '[123456789][0123456789][0123456789][0123456789][0123456789][0123456789][0123456789][0123456789]-[k]' THEN 
        RETURN TRUE;
    END IF;
    IF rute NOT LIKE '[123456789][0123456789][0123456789][0123456789][0123456789][0123456789][0123456789][0123456789]-[K]' THEN 
        RETURN TRUE;
    ...
    IF rute NOT LIKE '[123456789][0123456789][0123456789][0123456789][0123456789][0123456789][0123456789]-[0123456789]' THEN 
        RETURN TRUE;
    END IF;
    IF rute not LIKE '[123456789][0123456789][0123456789][0123456789][0123456789][0123456789][0123456789]-[k]' THEN 
        RETURN TRUE;
    END IF;
    IF rute not LIKE '[123456789][0123456789][0123456789][0123456789][0123456789][0123456789][0123456789]-[K]' THEN 
        RETURN TRUE;
