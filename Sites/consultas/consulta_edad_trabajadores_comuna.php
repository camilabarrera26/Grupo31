...
<?php
  ...
  #Se construye la consulta como un string
 	$query = "SELECT comunas.comuna_cobertura, AVG(personal.edad) FROM comunas, tiendas, personaltienda, personal WHERE '%%$comuna%%' = comunas.comuna_cobertura AND comunas.did = tiendas.direccion AND tiendas.tid = personaltienda.tid AND personaltienda.eid = personal.eid GROUP BY comunas.comuna_cobertura;";
  echo $query;
